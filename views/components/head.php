    ...
    <link rel="stylesheet" href="<?= $this->asset('css/header.css'); ?>">
    ...
    <link rel="stylesheet" href="<?= $this->asset('css/ikon.css'); ?>">
    <link rel="stylesheet" href="<?= $this->asset('css/splitmain.css'); ?>">
    <link rel="stylesheet" href="<?= $this->asset('css/musicplayer.css'); ?>">
    <link rel="stylesheet" href="<?= $this->asset('css/sidebar.css'); ?>">
    <link rel="stylesheet" href="<?= $this->asset('css/buttons.css'); ?>">
